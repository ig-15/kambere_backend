...
from .models import User, Family, FamilyMember, FamilyStory,Story
from .models import Task , Challenge, Question, AdminUser, UserChallengeResult
...
class QuestionSerializer(serializers.ModelSerializer):
    class Meta:
        model = Question
        fields = '__all__'
        # fields = ['id', 'question_statement', 'choices', 'correct_answer']
        def create(self, validated_data):
...
class ChallengeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Challenge
        fields = ['id', 'title', 'challenge_type', 'creator', 'created_at', 'questions']


class UserChallengeResultSerializer(serializers.ModelSerializer):
    class Meta:
        model = UserChallengeResult
        fields = ['id', 'user', 'challenge', 'score', 'submitted_at']